...
\begin{question}
	设 $A = \{ x | (x+1)(x-2)^2 > 0\}$, $B = \{ x | 4^x > \frac{1}{2}\}$, 则 $A \cap B = (D)$.
	\begin{choices}
		\item $(-1, +\infty)$
		\item $(2, +\infty)$
		\item $(-\frac{1}{2}, +\infty)$
		\item $(-\frac{1}{2}, 2) \cup (2,+\infty)$
	\end{choices}
\end{question}

\begin{question}
	$(1+i) + (1+i)^2 + (1+i)^3$ 的虚部为 $(B)$.
	\begin{choices}
		\item $-5$
		\item $5$
		\item $-5i$
...
\begin{question}
	已知向量 $\boldsymbol{a}+3\boldsymbol{b}, 2\boldsymbol{a}-\boldsymbol{b}$ 能构成平面的一组基底, 则 $(A.)$ 也能构成基底.
	\begin{choices}
		\item $\boldsymbol{a},\boldsymbol{b}$
		\item $\boldsymbol{a+b},\boldsymbol{a-b}$
		\item $1$
		\item $2$
	\end{choices}
\end{question}
